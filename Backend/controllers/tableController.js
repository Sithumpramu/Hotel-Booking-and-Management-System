...
const createReservation = async(req,res) =>{
    ...
    //add doc to db
    try{
        const table = await Table.create({Date, Name, Capacity, email, contactNumber})
        res.status(200).json(table)
    }catch(error){
...
module.exports = {
    createReservation,getAllReservations,getSingleReservation,deleteReservation,updateReservation
}
