...
const AddReserv = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await addReserv(CusName, TelNo, Address, checkinTime, AdvancePayment, activityIds);
    };

    const validate = () => {
        const allFieldsFilled = CusName && TelNo && Address && checkinTime && AdvancePayment;
            ...
            <div className="d-flex align-items-center justify-content-center mb-3 mt-5">
                <form onSubmit={handleSubmit} method="Post" style={{ width: "18rem" }}>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="customerName" onChange={(e) => setCusName(e.target.value)} />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="contactNumber" className="form-label">Contact Number</label>
                        <input type="number" className="form-control" id="contactNumber" onChange={(e) => setTelNo(e.target.value)} />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="time" className="form-control" id="checkinTime" onChange={(e) => setcheckinTime(e.target.value)} />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="advancePayment" className="form-label">Advance Payment</label>
                        <input type="number" className="form-control" id="advancePayment" onChange={(e) => setAdvancePayment(e.target.value)} />
                    </div>
