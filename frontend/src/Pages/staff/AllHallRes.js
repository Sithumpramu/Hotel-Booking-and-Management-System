...
const filteredReservations = hallReserves
  ? hallReserves.filter((reservation) => {
      ...
      const hallNameMatch = !selectedHallName || reservation.hallid === selectedHallName;
      const reservationNameMatch =!selectedReservationName ||
        reservation.hall.toLowerCase().includes(selectedReservationName.toLowerCase());
      return dateMatch && hallNameMatch && reservationNameMatch;
    })
  : [];
