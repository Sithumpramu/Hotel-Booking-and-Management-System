    ...
    return(
        ...
        <div className="d-flex flex-column  mt-5 justify-content-around fs-5" style={{height:"250px"}}>
          <li className="nav-item border">
            <a className="nav-link text-white fs-6" aria-current="page" href="/CombinedInventory">Kitchen Inventory</a>
          </li>
          <li className="nav-item border">
            <a className="nav-link text-white fs-6" aria-current="page" href="/BulkStock">Bulk Inventory</a>
          </li>
          <li className="nav-item border">
            <a className="nav-link text-white fs-6" aria-current="page" href="/KitchenInventory">Fresh Produce Inventory</a>
          </li>
          <li className="nav-item border">
            <a className="nav-link text-white fs-6" aria-current="page" href="/ManagerDashboard">Home</a>
          </li>
